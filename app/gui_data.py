"""
DataMixin — data tab, data loading, and data-management methods.
"""
...
from app.app_paths import DATA_FILE, _DATA_ROOT
from app.gui_quality import QualityMixin


class DataMixin(QualityMixin):
